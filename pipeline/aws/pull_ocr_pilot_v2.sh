#!/bin/bash
# Pull OCR pilot v2 results from S3; optionally terminate leftover EC2.
#
#   bash aws/pull_ocr_pilot_v2.sh          # wait for DONE then pull
#   bash aws/pull_ocr_pilot_v2.sh --now    # pull whatever is there
set -euo pipefail
...
# Ensure EC2 is not left running (userdata shuts down, but belt-and-suspenders)
