...
|---|---|---|---|
| Community 72k | DONE | 100% | EC2=unknown · `{   "phase": "all",   "status": "done",   "n_ids": 68011,   "ts": "2026-08-04T01:42:49Z",   "bucket": "sagemaker-studio-` |
| OWL CPU backfill | RUNNING | 6025/19263 (31.3%) device=cpu | ts=2026-08-04T05:06:08Z · EC2 `i-0b9777ca835a6d5ab` running c5.2xlarge · ETA~11.0h · sano |
| Custom Labels v202608040132 | TRAINING_COMPLETED | F1=0.6454153060913086 | The model is ready to run. · compare_f1.json already present |


---

## 2026-08-04T05:32:00Z — tick
...
|---|---|---|---|
| Community 72k | DONE | 100% | EC2=unknown · `{   "phase": "all",   "status": "done",   "n_ids": 68011,   "ts": "2026-08-04T01:42:49Z",   "bucket": "sagemaker-studio-` |
| OWL CPU backfill | RUNNING | 6500/19263 (33.7%) device=cpu | ts=2026-08-04T05:30:44Z · EC2 `i-0b9777ca835a6d5ab` running c5.2xlarge · ETA~10.6h · sano |
| Custom Labels v202608040132 | TRAINING_COMPLETED | F1=0.6454153060913086 | The model is ready to run. · compare_f1.json already present |


---

## 2026-08-04T06:06:07Z — tick
...
|---|---|---|---|
| Community 72k | DONE | 100% | EC2=unknown · `{   "phase": "all",   "status": "done",   "n_ids": 68011,   "ts": "2026-08-04T01:42:49Z",   "bucket": "sagemaker-studio-` |
| OWL CPU backfill | RUNNING | 7175/19263 (37.2%) device=cpu | ts=2026-08-04T06:04:34Z · EC2 `i-0b9777ca835a6d5ab` running c5.2xlarge · ETA~10.1h · sano |
| Custom Labels v202608040132 | TRAINING_COMPLETED | F1=0.6454153060913086 | The model is ready to run. · compare_f1.json already present |


---

## 2026-08-04T06:13:39Z — tick
...
|---|---|---|---|
| Community 72k | DONE | 100% | EC2=unknown · `{   "phase": "all",   "status": "done",   "n_ids": 68011,   "ts": "2026-08-04T01:42:49Z",   "bucket": "sagemaker-studio-` |
| OWL CPU backfill | RUNNING | 7275/19263 (37.8%) device=cpu | ts=2026-08-04T06:10:43Z · EC2 `i-0b9777ca835a6d5ab` running c5.2xlarge · ETA~10.0h · sano |
| Custom Labels v202608040132 | TRAINING_COMPLETED | F1=0.6454153060913086 | The model is ready to run. · compare_f1.json already present |


---

## 2026-08-04T06:13:46Z — tick
...
|---|---|---|---|
| Community 72k | DONE | 100% | EC2=unknown · `{   "phase": "all",   "status": "done",   "n_ids": 68011,   "ts": "2026-08-04T01:42:49Z",   "bucket": "sagemaker-studio-` |
| OWL CPU backfill | RUNNING | 7875/19263 (40.9%) device=cpu | ts=2026-08-04T06:41:32Z · EC2 `i-0b9777ca835a6d5ab` running c5.2xlarge · ETA~9.5h · sano |
| Custom Labels v202608040132 | TRAINING_COMPLETED | F1=0.6454153060913086 | The model is ready to run. · compare_f1.json already present |


---

## 2026-08-04T07:10:01Z — tick
...
|---|---|---|---|
| Community 72k | DONE | 100% | EC2=unknown · `{   "phase": "all",   "status": "done",   "n_ids": 68011,   "ts": "2026-08-04T01:42:49Z",   "bucket": "sagemaker-studio-` |
| OWL CPU backfill | RUNNING | 8425/19263 (43.7%) device=cpu | ts=2026-08-04T07:09:15Z · EC2 `i-0b9777ca835a6d5ab` running c5.2xlarge · ETA~9.0h · sano |
| Custom Labels v202608040132 | TRAINING_COMPLETED | F1=0.6454153060913086 | The model is ready to run. · compare_f1.json already present |


---

## 2026-08-04T07:33:40Z — tick
...
## 2026-08-04T12:20:11Z — tick

### AWS: **OK** (`arn:aws:sts::567596065542:assumed-role/WSParticipantRole/Participant`)

| Job | Status | Progress | Detail |
|---|---|---|---|
| Community 72k | DONE | 100% | EC2=unknown · `{   "phase": "labels",   "status": "running",   "done_batch": 825,   "todo": 5727,   "ok": 825,   "err": 0,   "total_row` |
| OWL CPU backfill | STALE? | 12325/19263 (64.0%) device=cpu | ts=2026-08-04T10:29:27Z · EC2 `i-0b9777ca835a6d5ab` running c5.2xlarge · ETA~5.8h · ⚠️ progress stale >12min |
| Custom Labels v202608040132 | TRAINING_COMPLETED | F1=0.6454153060913086 | The model is ready to run. · compare_f1.json already present |
